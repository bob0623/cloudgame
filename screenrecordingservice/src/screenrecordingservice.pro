QT       += core gui opengl core5compat openglwidgets
...
INCLUDEPATH += $$HOME_BASE/3rdparty/include
INCLUDEPATH += $$HOME_BASE/3rdparty/metartc/include
win32{
    INCLUDEPATH += ./
    CONFIG(debug, debug|release) {
        LIBS += -L$$HOME_BASE/3rdparty/metartc/src/bin/lib_win_debug
        LIBS += -L$$HOME_BASE/3rdparty/lib
        DESTDIR += $$HOME_BASE/renderproxy/x64/Debug
    }else{
        LIBS += -L$$HOME_BASE/bin/lib_win_release
        LIBS += -L$$HOME_BASE/3rdparty/lib
        DESTDIR += $$HOME_BASE/renderproxy/x64/Release
    }
    LIBS += -lmetartc7  -lmetartccore7 -lyuv -lopenh264 -lspeexdsp -lopus -lavutil -lavcodec -lusrsctp -lksuser -lwinmm  -lole32 -lStrmiids -lAvrt -lmf -lmfplat -lmfreadwrite -ld3d11 -lPropsys -lsrtp2  -llibcrypto -llibssl -ldxva2 -lws2_32
    ...
    # LIBS +=  $$YANG_LIB
    # LIBS +=   -lCrypt32 -lws2_32 -lOpenGL32
}
